  ...
  return (
    ...
    >
      {section10Data.map((item, index) => (
        <motion.div
          key={index}
          className="flex flex-col w-full h-[150px] group relative items-center justify-center text-center p-4 cursor-pointer overflow-hidden"
          style={{
        ...
        >
          ...
          <motion.h3
            className="text-[21px] font-semibold text-white relative p-2 rounded z-10"
